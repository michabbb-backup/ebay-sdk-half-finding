...
$autoLoader = 'dts-half-finding-autoloader.php';
...
$packager->createZip(__DIR__ . '/artifacts/dts-half-finding.zip');
$packager->createPhar(__DIR__ . '/artifacts/dts-half-finding.phar', null, $autoLoader);
